...
<div class="page-container">
	...
	<a href="javascript:;" onclick="admin_add('添加管理员','/admin-add.jsp','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>${fn:length(requestScope.adminList)}</strong> 条</span> </div>
